...
# Game arguments
parser.add_argument('--game_name', type=str, help='Name of the rtfm environment to use, e.g. groups_simple_stationary', default="groups_simple")
parser.add_argument('--ucb_C', type=float, help='Exploration constant in UBC formula', default=1.0)
parser.add_argument('--discount', type=float, help='Discount factor for future rewards', default=0.99)
...
def main():
    ...
    for i in range(args.n_episodes):
        ...
        pv_net.eval()
        results = train.play_rollout_pv_net_stochastic(pv_net,
                                                        game_simulator,
                                                        args.episode_length,
                                                        args.ucb_C,
                                                        args.discount,
